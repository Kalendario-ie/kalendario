...
import {ServiceCategoryPublicResourceModel, ServicePublicResourceModel} from 'src/app/api/api';
...
interface CompanyServicesListProps {
    services: ServicePublicResourceModel[];
    categories: ServiceCategoryPublicResourceModel[];
