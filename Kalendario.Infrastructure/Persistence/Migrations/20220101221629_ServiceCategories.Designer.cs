...
namespace Kalendario.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20220101221629_ServiceCategories")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kalendario.Core.Domain.ServiceCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kalendario.Core.Domain.Appointment", b =>
                {
                    ...
                    b.HasOne("Kalendario.Core.Domain.Service", null)
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("Kalendario.Core.Domain.Service", b =>
                {
                    ...
                    b.HasOne("Kalendario.Core.Domain.ServiceCategory", "ServiceCategory")
                        .WithMany("Services")
