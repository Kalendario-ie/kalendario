...
namespace Kalendario.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20220128112041_AddEmployeeImageUrl")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeSchedulingPanel", b =>
                {
                    b.Property<Guid>("EmployeesId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("SchedulingPanelsId")
                        .HasColumnType("uuid");

                    b.HasKey("EmployeesId", "SchedulingPanelsId");

                    b.HasIndex("SchedulingPanelsId");

                    b.ToTable("EmployeeSchedulingPanel");
                });
            ...
            modelBuilder.Entity("Kalendario.Core.Entities.AuditEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kalendario.Core.Entities.SchedulingPanel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kalendario.Core.Infrastructure.ApplicationRole", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Kalendario.Core.Infrastructure.ApplicationRoleGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kalendario.Core.Infrastructure.RoleGroupRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EmployeeSchedulingPanel", b =>
                {
                    b.HasOne("Kalendario.Core.Entities.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Kalendario.Core.Entities.SchedulingPanel", null)
                        .WithMany()
                        .HasForeignKey("SchedulingPanelsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Kalendario.Core.Infrastructure.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("Kalendario.Core.Infrastructure.ApplicationRoleGroup", "RoleGroup")
                        .WithMany()
            ...
            modelBuilder.Entity("Kalendario.Core.Infrastructure.RoleGroupRole", b =>
                {
                    ...
                    b.HasOne("Kalendario.Core.Infrastructure.ApplicationRole", "Role")
                        .WithMany("RoleGroupRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Kalendario.Core.Infrastructure.ApplicationRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
